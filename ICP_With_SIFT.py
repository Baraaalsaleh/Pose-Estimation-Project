...
#>>>>> This function creates the intrinsic camera matrix using bag file
def get_camera_intrinsic_matrix(bag_path):
    ...
    color_intrinsics = get_camera_intrinsic_matrix_old(camera_width_pixels = color_intrin.width, camera_hight_pixels = color_intrin.height, optical_center_x = color_intrin.fx, optical_center_y = color_intrin.fy, s=0, px= color_intrin.ppx, py = color_intrin.ppy)
    depth_intrinsics = get_camera_intrinsic_matrix_old(camera_width_pixels = depth_intrin.width, camera_hight_pixels = depth_intrin.height, optical_center_x = depth_intrin.fx, optical_center_y = depth_intrin.fy, s=0, px= depth_intrin.ppx, py = depth_intrin.ppy)
