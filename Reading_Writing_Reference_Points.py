...
def get_full_description (images, bag_paths, octaves = [8],NFeatures = 100):
    floor_depth = get_depth(bag_paths[0])
    print("Floor Depth is: " + str(floor_depth))
...
def compare_image_with_reference_data(path_to_reference_data, path_to_image, matching_threshold = 0.9):
